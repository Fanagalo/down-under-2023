	...
	function carpress_scripts() {
		if ( ! is_admin() && ! is_login_page() ) {
			...
			wp_localize_script( 'custom-js', 'CarpressJS', array(
				...
				'carouselInterval'           => get_theme_mod( 'front_carousel_interval', 1000),
...
/**
 * 20201202 Jaap Wiering
 * disable password recovery due to increased attacks from different sources
 * also disabled WooCommerce MyAccount page
 * password recovery procedure result in 404 error
 * source of code: https://www.isitwp.com/disable-the-allow_password_reset-feature/ 
 */
